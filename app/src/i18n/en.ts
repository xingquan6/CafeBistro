export const en = {
  ...
  pages: {
    ...
    contact: {
      ...
      heroTitle: 'Visit or say hello',
      heroSubtitle: 'Drop by the counter, or send us a note — we read every one.',
      sendNoteEyebrow: 'Send A Note',
      sendNoteTitle: 'Get in touch',
      thanksTitle: 'Thanks for reaching out!',
      thanksBody: 'This is a demo form with no backend attached — for a real message right now, email us directly at',
      formName: 'Name',
      formEmail: 'Email',
      formMessage: 'Message',
    },
