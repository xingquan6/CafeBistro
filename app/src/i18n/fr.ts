...
export const fr = {
  ...
  pages: {
    ...
    contact: {
      heroEyebrow: 'Restons en contact',
      heroTitle: 'Venez nous voir ou écrivez-nous',
      heroSubtitle: 'Passez au comptoir, ou envoyez-nous un mot — nous lisons chacun d\'entre eux.',
      sendNoteEyebrow: 'Envoyez-nous un mot',
      sendNoteTitle: 'Restons en contact',
      thanksTitle: 'Merci de nous avoir écrit!',
      thanksBody: "Ce formulaire de démonstration n'est relié à aucun serveur — pour nous joindre dès maintenant, écrivez-nous directement à",
      formName: 'Nom',
      formEmail: 'Courriel',
      formMessage: 'Message',
    },
